defmodule ViverderirWeb.AccountsController do
  ...
  def get_me(conn, _params) do
    item = ~s({"account":{"id":1,"name":"Account 1","email":"account@account.com","email_confirmed":true,"photo":"string","password":"xxxxxxxxx","password_hash":"xxxxxxxxx","access_failed_count":0,"lockout":"xxxxxxxxx","created_at":"2019-01-01 00:00:00","created_by":"1","updated_at":"2019-01-01 00:00:00","updated_by":"1","deleted_at":null,"deleted_by":null}})
